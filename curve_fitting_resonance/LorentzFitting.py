# -*- coding: utf-8 -*-
"""
Created on Sat Mar 11 16:18:19 2023
...
def width(fraction_input, uncertainty_input):
    ...
    # %%PLOT Ca Cb
    plt.scatter(Capacitance_a, dC_at, marker='x', s=50)
    plt.scatter(Capacitance_b, dC_bt, marker='x', s=50)
    # plt.axvline(Capacitance_a + uncertainty_input, c='grey', alpha = 0.5, linestyle='--')
    # plt.axvline(Capacitance_a - uncertainty_input, c='grey', alpha = 0.5, linestyle='--')
    # plt.axvline(Capacitance_b + uncertainty_input, c='grey', alpha = 0.5, linestyle='--')
    # plt.axvline(Capacitance_b - uncertainty_input, c='grey', alpha = 0.5, linestyle='--')
    plt.axhline(x_resonant_peak, c='pink', alpha=0.5, linestyle='--')
...
plt.scatter(xvals[maxvalinx], yvals[maxvalinx],
            label='Measured Resonant Peak', marker='x', s=50)
...
# %% Main Plot FWHM
plt.scatter(Lower_Half_Capacitance, dC_Lt,
            label='Lower Half Peak', marker='x', s=50)
plt.scatter(Upper_Half_Capacitance, dC_Ut,
            label='Upper Half Peak', marker='x', s=50)

plt.axvline(Lower_Half_Capacitance + 0.003E-9,
            c='grey', alpha=0.5, linestyle='--')
plt.axvline(Lower_Half_Capacitance - 0.003E-9,
            c='grey', alpha=0.5, linestyle='--')
plt.axvline(Upper_Half_Capacitance + 0.003E-9,
            c='grey', alpha=0.5, linestyle='--')
plt.axvline(Upper_Half_Capacitance - 0.003E-9,
            c='grey', alpha=0.5, linestyle='--')
...
plt.axvline(resonant_peak_pos + averagespacing,
            c='grey', alpha=0.5, linestyle='--')
plt.axvline(resonant_peak_pos - averagespacing,
            c='grey', alpha=0.5, linestyle='--')
...
try:
    ...
    plt.plot(xrange, fittedvals, label='Fitted function', c='grey')
except Exception:
